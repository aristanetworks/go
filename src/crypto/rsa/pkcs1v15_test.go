...
var (
	...
	decryptPKCS1v15Tests           []DecryptPKCS1v15Test
	decryptPKCS1v15SessionKeyTests []DecryptPKCS1v15Test
	signPKCS1v15Tests              []signPKCS1v15Test
)
...
func init() {
	...
	if boring.Enabled() {
		decryptPKCS1v15Tests = boringDecryptPKCS1v15Tests
		decryptPKCS1v15SessionKeyTests = boringDecryptPKCS1v15SessionKeyTests
		signPKCS1v15Tests = boringSignPKCS1v15Tests
		rsaPrivateKey = boringRSAPrivateKey
	}
}
